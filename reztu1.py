...
wait = {
    ...
    "comment":" \n \n\n \n + \n1  \n1   + 2 \n1   + 3 \n1   + 4 \n1   + 5 \n 3-11  \n \n  \n\n  Creator$ëIF-ot \nline.me/ti/p/~reza.p.i.p\nline.me/ti/p/~reza.p.i.p\n c_+_\n",
    "message":"Terim Ksih y....\nUdh Menmbhkn Sy Sebgi Temn nd.\nSemog Kit Bis Jlin Silturhmi Dengn Bik.\n\n y:R.D'TOLA",
}
read = {
    "readPoint":{},
    "readMember":{},
...
def help1():
    ...
    helpMessage1 = " " + key + " [®DT~t]\n" + \
                  ...
                  " " + key + "s:\n" + \
                   ...
                   " " + key + "s: \n" + \
                   "]   : BANG RDT ] \n" + \
                   "  Creator:  line.me/ti/p/~BANGDT.p.i.p"
...
def help2():
    ...
    helpMessage2= "      SETTING RDT-BOT\n" + \
                  ...
                  "] " + key + "s :x\n" + \
                  " [RDTBOT-LINE]    \n" + \
                  "Creator:  line.me/ti/p/~zhynagahytam.p.i.p"
...
def help3():
    ...
    helpMessage3 = "      MUSIK JBP\n" + \
                  ...
                  ": BANGRDT    \n" + \
                  "  Creator:  line.me/ti/p/~zhynaga.p.i.p"
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\n : {}".format(dt_to_str(cTime_to_datetime(msg_dict[msg_id]["createdTime"])))
                                ret_ += "\n• s : {}".format(str(msg_dict[msg_id]["text"]))
                                ret_ += "\n Tim RDT-BOT    "
                                ret_ += "\nCreator:  line.me/ti/p/~zhynaga.p.i.p" 
        ...
        if op.type == 25 or op.type == 26:
            ...
            if msg.toType == 2:
               ...
               if msg.contentType == 16:
                    if wait["Timeline"] == True:
                            ...
                            if msg.contentMetadata["serviceType"] == "GB":
                                ...
                                auth = "\n•   s : {}".format(str(contact.displayName))
                            else:
                                auth = "\n•   s : {}".format(str(msg.contentMetadata["serviceName"]))
                            ret_ += auth
                            if "stickerId" in msg.contentMetadata:
                                stck = "\n•   s : https://line.me/R/shop/detail/{}".format(str(msg.contentMetadata["packageId"]))
                                ret_ += stck
               ...
               if msg.contentType == 7:
                   ...
                   ret_ += "\n• s s : {}".format(stk_ver)
                   ret_ += "\n• s  : {}".format(pkg_id)
                   ret_ += "\n• s : line://shop/detail/{}".format(pkg_id)
                   query = int(stk_id)
                   if type(query) == int:
                ...
                if wait["stickerOn"] == True:
                    ...
                    with requests.session() as s:
                        ...
                        if data == 'Lihat Produk Lain':
                            ...
                            ret_ += "\n• s  : {}".format(str(stk_id))
                            ret_ += "\n• s  : {}".format(str(pkg_id))
                            ret_ += "\n• s s : {}".format(str(stk_ver))
                            ret_ += "\n• s  : line://shop/detail/{}".format(str(pkg_id))
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                zx2 = []
                                xpesan =  " s s \n•   s : "
                                ret_ = "•  : {} ".format(str(len(grouplist)))
                                ret_ += "\n•  : {} ".format(str(len(contactlist)))
                                ret_ += "\n•  : {} ".format(str(len(blockedlist)))
                                ret_ += "\n•  : {} ".format(str(len(favoritelist)))
                                ret_ += "\n• s :  s  "
                                ret_ += "\n• x : {} - {} - {}".format(str(hr), str(bln), str(thn))
                                ret_ += "\n•  s : {} ".format(days)
...
">>>_  >><\n  \n<<<<<<<<<>>\nhttp://line.me/ti/p/~reza.p.i.p\nhttp://line.me/ti/p/ryansakra_m1")
                        ...
                        elif cmd == "RDT-Bot" or cma =="RDTBot":
